...
import static com.jiangdg.utils.UvcLog.d;
...
import com.serenegiant.encoder.AudioCatcher;
...
import com.serenegiant.proxy.MediaProxy;
import com.serenegiant.widget.CameraViewInterface;
import com.jiangdg.utils.UvcLog;
import com.wg.libusbuvc.R;
...
abstract class AbstractUVCCameraHandler extends Handler {
    ...
    private static final int MSG_FLOW_START = 10;
    private static final int MSG_FLOW_STOP = 11;
    ...
    public void startFlow() {
        sendEmptyMessage(MSG_FLOW_START);
    }

    public void stopFlow() {
        sendEmptyMessage(MSG_FLOW_STOP);
    }
    ...
    public void handleMessage(final Message msg) {
        ...
        switch (msg.what) {
            ...
            case MSG_CAPTURE_STOP:
                ...
                break;
            case MSG_FLOW_STOP:
                thread.handlerStopFlow();
                break;
            case MSG_FLOW_START:
                thread.handlerStartFlow();
                break;
    ...
    static final class CameraThread extends Thread {
        ...
        public void handleCaptureStill(final String path) {
            ...
            try {
                ...
                final File outputFile = TextUtils.isEmpty(path) ? MediaMuxerWrapper.getCaptureFile(Environment.DIRECTORY_DCIM, ".png") : new File(path);
        ...
        private AudioCatcher mAudioCatcher;


        public void handlerStartFlow() {
            try {
                d(TAG, "handlerStartFlow: ");
                mUVCCamera.setFrameCallback(mIFrameCallback, UVCCamera.PIXEL_FORMAT_YUV420SP);
//                if (mAudioCatcher == null) {
//                    mAudioCatcher = new AudioCatcher();
//                    mAudioCatcher.setOnAudioFrameCapturedListener(new AudioCatcher.OnAudioFrameCapturedListener() {
//                        @Override
//                        public void onAudioFrameCaptured(@Nullable byte[] audioData) {
//                            d(TAG, "onAudioFrameCaptured: ");
//                            MediaProxy.onAudioResult(audioData, System.nanoTime());
//                        }
//                    });
//                }
//                if (ActivityCompat.checkSelfPermission(mWeakParent.get(), Manifest.permission.RECORD_AUDIO) == PackageManager.PERMISSION_GRANTED) {
//                    mAudioCatcher.startCapture();
//                } else {
//                    UvcLog.d(TAG, "handlerStartFlow: no permission RECORD_AUDIO");
//                }
            } catch (Exception e) {
                UvcLog.d(TAG, "handlerStartFlow: " + e);
            }
        }

        public void handlerStopFlow() {
            try {
                mUVCCamera.setFrameCallback(null, 0);
                if (mAudioCatcher != null) {
                    mAudioCatcher.stopCapture();
                }
            } catch (Exception e) {
                UvcLog.d(TAG, "handlerStopFlow: ");
            }
        }
        ...
        private final IFrameCallback mIFrameCallback = new IFrameCallback() {
            ...
            public void onFrame(final ByteBuffer frame) {
                ...
                MediaProxy.onVideoResult(frame, System.nanoTime());
//                synchronized (mSync) {
...
//                }
        ...
        private final MediaEncoder.MediaEncoderListener mMediaEncoderListener = new MediaEncoder.MediaEncoderListener() {
            ...
            public void onStopped(final MediaEncoder encoder) {
                ...
                if ((encoder instanceof MediaVideoEncoder) || (encoder instanceof MediaSurfaceEncoder)) try {
                    mIsRecording = false;
                    final Activity parent = mWeakParent.get();
                    mWeakCameraView.get().setVideoEncoder(null);
                    synchronized (mSync) {
