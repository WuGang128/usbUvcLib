...
import static com.topdon.remoteservice.utils.Logger.d;
...
//                } else {
//                    Logger.d(TAG, "handlerStartFlow: no permission RECORD_AUDIO");
//                }
            } catch (Exception e) {
                d(TAG, "handlerStartFlow: " + e);
            }
        }
