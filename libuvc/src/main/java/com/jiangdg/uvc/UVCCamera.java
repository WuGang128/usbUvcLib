...
public class UVCCamera {
    ...
    public static final int PU_AVIDEO_STD = 0x80010000;    // D16: AnaLogger Video Standard
    public static final int PU_AVIDEO_LOCK = 0x80020000;    // D17: AnaLogger Video Lock Status
    ...
    protected int mAnaLoggerVideoStandardMin, mAnaLoggerVideoStandardMax, mAnaLoggerVideoStandardDef;
    protected int mAnaLoggerVideoLockStateMin, mAnaLoggerVideoLockStateMax, mAnaLoggerVideoLockStateDef;
    // until here
...
//			long id_camera, int venderId, int productId, int fileDescriptor, int busNum, int devAddr, String usbfs
        ...
        if (USBMonitor.DEBUG) {
            Logger.i(TAG, "open camera status: " + mNativePtr + ", size: " + mSupportedSize);
        }
...
//    		mNativePtr = 0;	// nativeDestroyを呼ぶのでここでクリアしちゃダメ
        ...
        if (DEBUG) Logger.v(TAG, "close:finished");
    }
...
// 			   Logger.d(TAG, "setZoom:zoom=" + zoom + " ,value=" + z);
...
//================================================================================
        ...
        if (mNativePtr != 0) {
            if ((mControlSupports == 0) || (mProcSupports == 0)) {
                ...
                if (false) {
                    ...
                    Logger.v(TAG, String.format("WhiteBlance:min=%d,max=%d,def=%d", mWhiteBlanceMin, mWhiteBlanceMax, mWhiteBlanceDef));
    ...
    private static final String[] SUPPORTS_PROC = {
            ...
            "D16: AnaLogger Video Standard",
            "D17: AnaLogger Video Lock Status",
            "D18: Contrast, Auto",
